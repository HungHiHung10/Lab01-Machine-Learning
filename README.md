...
---
*💡 **Mẹo:** Các file `.ipynb` có kích thước tương đối lớn (lên tới hàng trăm MB) do có thể đã lưu sẵn các output cache (video, hình ảnh mã hóa dạng base64). Bạn có thể clear output của notebook trước khi commit nếu muốn dung lượng thư mục nhẹ hơn.*
